...
did int primary key,
dname varchar(20),
sid int references state(sid));//this will create foreign key</p>
...
<p>
insert into student values(4001,'rajesh','kumar','1994-05-01','250-a-3-3','rajanagar','NGV palli','M');</p>
<p>
...
l3 int references subject(subid));</p>
<p>
